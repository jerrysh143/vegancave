...
const Header = () => {
  ...
  return (
    <div
      className={`z-[999] px-15px ${scrollPosition > 50
      ...
      <div className="w-full max-w-full 1600:w-[1530px] mx-auto">
        <div className="flex flex-wrap justify-between items-center">
          <div className="w-2/12 md:w-5/12 px-15px flex justify-start">
            ...
            >
              <MobileMenu
                className={`z-[99] flex fixed top-0 left-0 m-15px w-[calc(100%-30px)] 500:w-[calc(100%-50%)] md:w-[calc(100%-80%)] ${Menu
                    ? "translate-x-0 opacity-100 duration-150 transition-all"
                    : "-translate-x-full opacity-0 duration-150 transition-all"
                  }`}
              />
          ...
          <div className="w-4/12 md:w-5/12 px-15px flex items-center justify-end gap-15px">
            ...
            <div className={`z-[99] fixed top-0 right-0 m-15px rounded-15px bg-white w-5/12 h-[calc(100dvh_-_30px)] ${Search ? "translate-x-0 opacity-100 duration-150 transition-all":"translate-x-full opacity-0 duration-150 transition-all"} `}>
